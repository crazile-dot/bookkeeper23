...
public class SimpleClientBase extends AbstractAutoAsyncCloseable {
    ...
    protected final Object settings = 1;
    protected final Resource<Object> schedulerResource = null;
    protected final Object scheduler = 1;
    protected final ManagedChannel managedChannel = null;
    protected final boolean ownChannel = false;
    protected final Channel channel = null;
    protected final RetryUtils retryUtils = null;

    protected SimpleClientBase(Object settings) {
